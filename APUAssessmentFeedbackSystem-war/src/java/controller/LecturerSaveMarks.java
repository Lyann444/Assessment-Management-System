 ...
 * @author USER
 */
@WebServlet(name = "LecturerSaveMarks", urlPatterns = {"/LecturerSaveMarks"})
public class LecturerSaveMarks extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        request.getParameterMap().forEach((key, value) -> {
            ...
            if (key.startsWith("marks_")) {
                ...
                resultFacade.saveOrUpdate(studentName, assessmentID, marks, feedback);
            }
        });
